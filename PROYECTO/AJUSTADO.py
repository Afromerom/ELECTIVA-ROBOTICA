...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.servomotor3 = GPIO.PWM(13, 50)  # pin 13 for servo3, pulse 50Hz
        GPIO.setup(26, GPIO.OUT)
        self.servomotor4 = GPIO.PWM(26, 50)  # pin 26 for servo4, pulse 50Hz
        ...
        layout = QtWidgets.QVBoxLayout(self.DISP)
    ...
    def actualizar_valor_servo3(self, value):
