...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        # Conecta las señales de los botones y deslizadores a las funciones correspondientes
    ...
    def toggle_led(self):
        if self.led_intensity == 0:
            ...
            self.changeColorBlue()  # Cambia el color del botón cuando el LED está encendido
        else:
            self.led_intensity = 0
            self.pwm_led.ChangeDutyCycle(self.led_intensity)
            self.ButtonLed1.setStyleSheet("")  # Restaura el color original del botón cuando el LED está apagado
            
    def toggle_led2(self):
        if self.led_intensity2 == 0:
            self.led_intensity2 = 100
            self.pwm_led2.ChangeDutyCycle(self.led_intensity2)
            self.changeColorGreen()  # Cambia el color del botón cuando el LED está encendido
        else:
            self.led_intensity2 = 0
            self.pwm_led2.ChangeDutyCycle(self.led_intensity2)
            self.ButtonLed2.setStyleSheet("")  # Restaura el color original del botón cuando el LED está apagado
